...
test('33 tables, RLS enabled, 3 restricted runtime roles, no cross-service foreign keys',async()=>{
  ...
  assert.deepEqual(tables.map(r=>[r.schemaname,r.count]),[['content',16],['identity',4],['learning',13]]);
