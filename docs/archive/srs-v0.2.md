...
**Cách đọc trạng thái:** Những định hướng đã xác nhận được ghi tại mục 1. Các lựa chọn mới, ngưỡng điểm, số lượng nội dung và quy tắc chi tiết trong bản 0.2 đều là **ĐỀ XUẤT** để có một đặc tả nhất quán, chưa phải quyết định đã được nhóm hoặc giảng viên duyệt. Việc chưa duyệt không ngăn nhóm dùng tài liệu để thảo luận, thiết kế và xác định khối lượng. Các điểm cần xác nhận bên ngoài nằm tại mục 12.
...
|---|---|---|
| Tài khoản | Đăng ký, xác minh email, đăng nhập, đăng xuất, quên mật khẩu, hồ sơ cơ bản | AUTH-01–04 |
...
Đăng nhập bằng email/mật khẩu; thông báo chung khi thông tin không hợp lệ. Hệ thống duy trì phiên trên thiết bị, yêu cầu đăng nhập lại khi phiên hết hiệu lực và không làm mất các kết quả đã được xác nhận lưu. Đăng xuất kết thúc phiên của thiết bị hiện tại; đăng nhập trên web và mobile cùng tài khoản được phép.
...
Người dùng yêu cầu liên kết đặt lại qua email. Thông báo phản hồi giống nhau với email tồn tại và không tồn tại. Liên kết chỉ dùng một lần, có thời hạn, không cho đặt mật khẩu yếu hơn AUTH-01. Sau đổi mật khẩu, các phiên cũ bị thu hồi và người dùng đăng nhập lại. Mở liên kết từ điện thoại phải hoàn thành được luồng đặt lại, có thể qua trang web.
...
Người học xem email và sửa tên hiển thị; đổi mật khẩu qua luồng xác thực phù hợp. Email là định danh không sửa trong MVP. Không yêu cầu avatar, ngày sinh, số điện thoại hoặc dữ liệu cá nhân không phục vụ việc học.
...
2. Khách xem bài học thử; đăng ký, xác minh và đăng nhập bằng tài khoản người học.
...
|---|---|
| Khách | Giới thiệu/danh mục, bài học thử, đăng ký, đăng nhập, xác minh, quên/đặt lại mật khẩu |
...
|---|---|
| Đăng ký, đăng nhập, đăng xuất, sửa hồ sơ | AUTH-01–04; bổ sung xác minh và phục hồi tài khoản |
