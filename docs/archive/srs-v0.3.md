...
**Cách đọc trạng thái:** Những định hướng đã xác nhận được ghi tại mục 1. Phạm vi lập kế hoạch bản web và việc bổ sung đăng nhập Google đã được người dùng yêu cầu. Các ngưỡng điểm, số lượng nội dung và quy tắc chi tiết còn lại là **ĐỀ XUẤT** để có một đặc tả nhất quán, chưa mặc định đã được nhóm hoặc giảng viên duyệt. Các điểm cần xác nhận bên ngoài nằm tại mục 12.
